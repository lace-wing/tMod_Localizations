...
namespace BloodSoul.NPCs.Bosses.SharaIshvalda
{
    class LeftArm2 : FSMnpc
    {
        ...
        private enum SharaIshvaldaHand2AI
        {
            St0,//待机
            St1,//沙暴
            St2,//沙弹
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] == 1)
            {
                SwitchState1((int)SharaIshvaldaHand2AI.St1, (int)SharaIshvaldaHand2AI.St1 + 1);
            }

            Vector2 ToTarget = (Target.position - NPC.position).SafeNormalize(Vector2.UnitX) * 15;
            switch ((SharaIshvaldaHand2AI)State1)
            {
                case SharaIshvaldaHand2AI.St0:
                    {
                        NPC.rotation = 0;
                        NPC.velocity *= 0;
                        break;
                    }
                case SharaIshvaldaHand2AI.St1:
                    {
                        Time2++;
                        if (Timer2 < 5)
                        {
                        ...
                        if (Time1 == 120)
                        {
                            ...
                            SwitchState1((int)SharaIshvaldaHand2AI.St0, (int)SharaIshvaldaHand2AI.St0 + 1);
                        }
                        break;
                    }
                case SharaIshvaldaHand2AI.St2:
                    {
                        Time2++;
                        if (Timer2 < 10)
                        {
