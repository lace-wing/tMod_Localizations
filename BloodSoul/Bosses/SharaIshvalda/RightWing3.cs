...
namespace BloodSoul.NPCs.Bosses.SharaIshvalda
{
    class RightWing3 : FSMnpc
    {
        ...
        public override void AI()
        {
            ...
            NPC.timeLeft = 99999;
            NPC.Center = Main.npc[(int)NPC.ai[1]].Center + new Vector2(+9, +175);
            switch ((Wing1AI)State1)
            {
                ...
                case Wing1AI.St1:
                    {
                        NPC.Shoot(NPC.Center + new Vector2(+50, 0), ModContent.ProjectileType<VacuumRay>(),
                                        145, TargetVel + new Vector2(Main.rand.NextFloat(-2, 2), 10), false, SoundID.Item45);
                ...
                case Wing1AI.St2:
                    {
                        NPC.Shoot(NPC.Center + new Vector2(+50, 0), ModContent.ProjectileType<VacuumRay>(),
                                        145, TargetVel + new Vector2(Main.rand.NextFloat(-2, 3), 10), false, SoundID.Item45);
                        NPC.Shoot(NPC.Center + new Vector2(+50, 0), ModContent.ProjectileType<VacuumRay>(),
                                        145, TargetVel + new Vector2(Main.rand.NextFloat(-2, 3), 10), false, SoundID.Item45);
                        SwitchState1((int)Wing1AI.St0, (int)Wing1AI.St0 + 1);
                        break;
