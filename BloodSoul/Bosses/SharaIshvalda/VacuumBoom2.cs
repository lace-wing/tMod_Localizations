...
{
    public class VacuumBoom2 : BaseProj
    {
        public int i = 0;
        ...
        {
            DisplayName.SetDefault("真空爆破");
        }
        public Color color = new Color(250, 250, 210, 25);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Color colour2 = Color.Lerp(new Color(250, 250, 210), new Color(250, 250, 210), 1f / BoomGlowTimer * 10f) * (1f / BoomGlowTimer * 10f);
            if (!BoomGlow)
            {
