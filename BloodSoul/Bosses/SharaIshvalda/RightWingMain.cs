    ...
    class RightWingMain : FSMnpc
    {
        ...
        public override void AI()
        {
            ...
            if (Body == 0)
            {
                int num1 = NPC.whoAmI;
                NPC.ai[3] = NPC.whoAmI;
                int SpawnBody1 = NPC.NewNPC(NPC.GetSpawnSourceForNPCFromNPCAI(), (int)(NPC.Center.X + NPC.width / 2), (int)(NPC.Center.Y + NPC.height), ModContent.NPCType<RightWing1>(), NPC.whoAmI);
                ...
                NPC.netUpdate = true;
                num1 = SpawnBody1;
                int SpawnBody2 = NPC.NewNPC(NPC.GetSpawnSourceForNPCFromNPCAI(), (int)(NPC.Center.X + NPC.width / 2), (int)(NPC.Center.Y + NPC.height), ModContent.NPCType<RightWing2>(), NPC.whoAmI);
                Main.npc[SpawnBody2].ai[3] = num1;
                Main.npc[SpawnBody2].ai[1] = num1;
                Main.npc[num1].ai[0] = SpawnBody2;
                Main.npc[SpawnBody2].realLife = NPC.whoAmI;
                Main.npc[SpawnBody2].rotation = NPC.rotation;
                int SpawnBody3 = NPC.NewNPC(NPC.GetSpawnSourceForNPCFromNPCAI(), (int)(NPC.Center.X + NPC.width / 2), (int)(NPC.Center.Y + NPC.height), ModContent.NPCType<RightWing3>(), NPC.whoAmI);
                Main.npc[SpawnBody3].ai[3] = num1;
                Main.npc[SpawnBody3].ai[1] = num1;
                Main.npc[num1].ai[0] = SpawnBody3;
            ...
            {
                if (n.type == ModContent.NPCType<RightWing1>() || n.type == ModContent.NPCType<RightWing2>() || n.type == ModContent.NPCType<RightWing3>() && n.active)
                {
