...
{
    public class StarBoomProj2 : BaseProj
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("爆炸星弹");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectileSource,Projectile.Center, new Vector2(0, 0), ModContent.ProjectileType<StarBoom>(), 200, 0, 0);
        }
    }
}
