...
{
    public class UangBoom : BaseProj
    {
        public int i = 0;
        ...
        {
            DisplayName.SetDefault("幻灵爆破");
        }
        public Color color = new Color(30, 144, 255, 25);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Color colour2 = Color.Lerp(new Color(30, 144, 255), new Color(30, 144, 255), 1f / BoomGlowTimer * 10f) * (1f / BoomGlowTimer * 10f);
            if (!BoomGlow)
            {
