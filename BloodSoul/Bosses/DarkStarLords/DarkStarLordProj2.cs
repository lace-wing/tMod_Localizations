...
{
    public class DarkStarLordProj2 : BaseProj
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("暗星蓄力弹");
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition, null, new Color(255, 215, 0, 100) * Projectile.Opacity, Projectile.rotation, drawSunOrigin, Projectile.scale * 1.5f, (Projectile.spriteDirection == 1) ? SpriteEffects.None : SpriteEffects.FlipHorizontally, 0);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectileSource,Projectile.Center, new Vector2(0, 0), ModContent.ProjectileType<DarkStarBoom>(), 250, 0, 0);
        }
    }
}
