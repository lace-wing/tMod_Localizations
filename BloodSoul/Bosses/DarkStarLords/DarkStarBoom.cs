...
{
    public class DarkStarBoom : BaseProj
    {
        public int i = 0;
        ...
        {
            DisplayName.SetDefault("暗星爆破");
        }
        public Color color = new Color(255, 215, 0, 25);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Color colour2 = Color.Lerp(new Color(255, 215, 0), new Color(255, 215, 0), 1f / BoomGlowTimer * 10f) * (1f / BoomGlowTimer * 10f);
            if (!BoomGlow)
            {
