...
{
    class AwakeningHolyPickaxe : FSMnpc
    {
        float r = 0;
        ...
        {
            DisplayName.SetDefault("Awakening·Holy Pickaxe");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "真·圣镐斧");
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Main.spriteBatch.Draw(texture2, NPC.Center - Main.screenPosition, null, new Color(255, 149, 202, 0), r, drawOrigin2, new Vector2(1.7f, 1.7f), SpriteEffects.None, 0);
            return true;
        }
    }
}
