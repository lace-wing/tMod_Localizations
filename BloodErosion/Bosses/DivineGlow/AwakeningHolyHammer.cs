...
{
    class AwakeningHolyHammer : FSMnpc
    {
        float r = 0;
        ...
        {
            DisplayName.SetDefault("Awakening·Holy Hammer");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "真·圣锤");
        }
