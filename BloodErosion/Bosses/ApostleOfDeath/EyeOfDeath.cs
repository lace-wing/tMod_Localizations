...
namespace BloodErosion.NPCs.Bosses.ApostleOfDeath
{
    class EyeOfDeath : FSMnpc
    {
        ...
        public override void AI()
        {
            ...
            Vector2 Head = new Vector2(Target.Center.X, Target.Center.Y - 300);
        ...
        public override bool CheckDead()
        {
            ...
            {
                if (n.type == ModContent.NPCType<EyeOfDeath2>() || n.type == ModContent.NPCType<EyeOfDeath3>() && n.active)
                {
                    n.active = false;
                    n.netUpdate = true;
                }
