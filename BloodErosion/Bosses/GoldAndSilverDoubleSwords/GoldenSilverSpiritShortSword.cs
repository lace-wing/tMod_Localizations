...
{
    class GoldenSilverSpiritShortSword : BaseProj
    {
        private Vector2 OldVec = Vector2.Zero;
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("GoldenSilverSpiritShortSword");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "金银短剑");
        ...
        public override void AI()
        {
            ...
            {
                if(npc.type == ModContent.NPCType<GoldenSpiritSword>() && npc.type == ModContent.NPCType<SilverSpiritSword>() && !npc.active)
                {
