...
{
    [AutoloadBossHead]
    class SilverSpiritSword : GoldAndSilverDoubleSword
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Silver Spirit Sword");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "银灵剑");
        ...
        public override bool CheckDead()
        {
            ...
            {
                if (n.type == ModContent.NPCType<GoldenSpiritSword>() && n.active)
                {
                    return false;
                }
            }
