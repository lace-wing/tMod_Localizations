...
{
    public class BigFireBall : BaseProj
    {
        private Vector2 OldVec = Vector2.Zero;
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("大火球球");
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = -10; i <= 10; i++)
            {
                ...
                Terraria.Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, shootVel, ModContent.ProjectileType<SparkBall>(), 20, 10, NPC.whoAmI);
            }
