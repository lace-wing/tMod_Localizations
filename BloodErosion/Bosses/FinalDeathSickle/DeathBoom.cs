...
{
    public class DeathBoom : BaseProj
    {
        public int i = 0;
        ...
        {
            DisplayName.SetDefault("死神爆破");
        }
        public Color color = new Color(148, 0, 211, 25);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Color colour2 = Color.Lerp(new Color(148, 0, 211), new Color(148, 0, 211), 1f / BoomGlowTimer * 10f) * (1f / BoomGlowTimer * 10f);
            if (!BoomGlow)
            {
