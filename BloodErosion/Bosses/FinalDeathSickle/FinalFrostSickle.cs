...
namespace BloodErosion.NPCs.Bosses.FinalDeathSickle
{
    ...
    class FinalFrostSickle : FSMnpc
    {
        ...
        {
            DisplayName.SetDefault("Final Frost Sickle");
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "最终寒霜镰");
        }
                                    ...
                                    if (Time1 > 30)
                                    {
                                        ...
                                        if (Time2 > 4)
                                        {
                                            ...
                                            for (int i = 0; i < 12; i++)
                                            {
                                                ...
                                                FrostSwordWind, 40, 0f, Main.myPlayer);
                                                interval++;
                                            }
                                            //SwitchState2(1);
                                            Time2 = 0;
        ...
        public override bool CheckDead()
        {
            ...
            {
                if (n.type == ModContent.NPCType<FinalAwakeningSickle>() || n.type == ModContent.NPCType<FinalFlameSickle>() && n.active)
                {
                    n.active = false;
                    n.netUpdate = true;
                }
            }
            NPC.NewNPC(NPC.GetSpawnSourceForNPCFromNPCAI(), (int)(NPC.Center.X), (int)(NPC.Center.Y), ModContent.NPCType<FinalDeathSickle2>(), NPC.whoAmI);
