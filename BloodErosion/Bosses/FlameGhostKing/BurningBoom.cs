...
{
    public class BurningBoom : BaseProj
    {
        public int i = 0;
        ...
        {
            DisplayName.SetDefault("王炎爆破");
        }
        public Color color = new Color(185, 0, 0, 25);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Color colour2 = Color.Lerp(new Color(185, 0, 0), new Color(185, 0, 0), 1f / BoomGlowTimer * 10f) * (1f / BoomGlowTimer * 10f);
            if (!BoomGlow)
            {
